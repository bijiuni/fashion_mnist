...
fashion_data = fashion_data.values
np.random.shuffle(fashion_data)

X = fashion_data[:, 1:].reshape(-1, 28, 28, 1) / 255.0
Y = fashion_data[:, 0].astype(np.int32)
...
# set the losses, optimizer and metrics
model.compile(
